...
<div class="relative flex rounded-[13px] border border-zinc-200 w-full h-14 transition-colors hover:border-black">
    ...
    <button class="bg-[#3FF381] flex items-center justify-center px-4 whitespace-nowrap font-medium transition-all rounded-r-[13px] hover:bg-[#6dffa2] focus:outline-offset-4"> Brew it! </button>
</div>
