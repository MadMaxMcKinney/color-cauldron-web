...
{#if visible}
    <Overlay>
        <div in:scale={{ delay: 200, start: 0.8 }} out:scale={{ start: 0.8 }} class="flex min-w-56 flex-col overflow-clip rounded-[13px] shadow-md md:min-w-[350px]">
            <!-- Footer -->
            <header class="flex h-[70px] items-center gap-4 bg-white px-6 md:flex-row md:items-center">
